...
- Si el usuario menciona un vuelo, hotel o actividad, propón agregarlo al itinerario.
...
- Si el usuario sube un comprobante, recuérdale que el sistema lo validará automáticamente.`;
